...
<body>
	<div class="header">
		...
		<div class="left2">
			<a style="border-bottom: 3px solid #ffffff;" class="nut" href="trangchu"><span class="cn">Trang chủ</span></a> 
		...
		<div class="left2">
			<a style="border-bottom: 3px solid #ffffff;" class="nut" href="#"><span class="cn">Trang chủ</span></a> 
			<a class="nut" href="qlxe"><span class="cn">Xe</span></a>
			<a class="nut" href="qlhangxe"><span class="cn">Hãng xe</span></a>
			<a class="nut" href="qldon"><span class="cn">Xác nhận đơn</span></a>
		</div>
		<div class="right">
			<div class="dropdown">
	...
	<div class="body">
		<div style="background-color: #e73a37;" class="tb">
			<p class="nd">Hiện tại có ... đơn đợi xác nhận</p>
			
		</div>
		
		<div style="background-color: #fca41d;" class="tb">
			<p class="nd">Tổng cộng đã từ chối ... đơn do hết hàng</p>
			
		</div>
		
		<div style="background-color: #11b3c5;" class="tb">
			<p class="nd">Cửa hàng có ... loại xe và ... hãng xe</p>
		</div>
