...
<body>
	<div class="header">
		...
		<div class="right">
			<a style="margin-right: 10px;" class="nut3" href="login">Đăng nhập</a> <a class="nut2" href="register">Đăng
				ký</a>
	...
	<div class="body">
		<div class="box">
			...
			<p class="logincontent">Đăng nhập / Login</p>
			<hr style="color: #3779c9;width: 640px">
		</div>
		<form style="display: inline-grid;" action="loginuser" method="post">
			<input class="input" type="text" required="required" name="username" placeholder="Nhập tên đăng nhập / Username">
			<input class="input" type="password" required="required" name="password" placeholder="Nhập mật khẩu / Password">
			<div>
				<button class="loginbut">ĐĂNG NHẬP / LOGIN</button>
		...
		<div style="margin-top: -90px;">
			<div class="checkbox">
				<input type="checkbox">
				<span>Ghi nhớ tài khoản / Rememberme</span>
			</div>
			<div class="linkforgot">
				<a href="#">Quên mật khẩu? Forgot password?</a>
			</div>
			<div>
				<p style="position: relative;top: 100px;left: -80px;">Bạn chưa có tài khoản?</p>
				<a class="loginlink" href="register">Đăng ký ngay</a>
			</div>
		</div>
