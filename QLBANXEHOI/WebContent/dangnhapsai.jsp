...
<body>
		...
		<a href="htxecontroller">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    ...
		    <ul class="navbar-nav ">
		      ...
		      <!-- <li class="nav-item">
		        <a onclick="openPopup3()" class="nav-link" href="#">
		          <i style="margin-bottom: -4px;" class="fa fa-sign-in"></i>
		          Đăng nhập
		        </a>
		      </li> -->
	...
	<div id="popup3" style="border-radius:10px;border:1px solid black;top: 200px;left: 500px;position: fixed;border: 1px solid black;height: 400px;width: 650px;background-color: #ededed;" class="containersai">
		<button class="daux" style="margin-left: 620px;" onclick="openPopup3()" type="button"><i class="fa fa-times-circle" aria-hidden="true"></i></button>
		<div>
			<img style="height: 170px;width: 170px;margin-left: 240px;" src="al.png">
			<h1 style="margin-left: 32px;">Sai tên tài khoản hoặc mật khẩu</h1>
			<button class="buttdnl" onclick="openandclose()" style="margin-left: 266px;margin-top: 40px;border-radius: 10px;">Đăng nhập lại</button>
		</div>
