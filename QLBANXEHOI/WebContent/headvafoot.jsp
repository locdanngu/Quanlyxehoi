...
<body>
	<div class="header">
		...
		<div class="left2">
			...
			<a onclick="openPopup()" class="nut" href="#"><span>Xe</span></a>
			<a onclick="openPopup()" class="nut" href="#"><span>Hãng xe</span></a>
			<a onclick="openPopup()" class="nut" href="#"><span>Xác nhận đơn</span></a>
		</div>
		<div class="right">
		...
		<div class="left2">
			<a class="nut" href="#"><span style="color: #5b93f7">Trang chủ</span></a> 
			<a class="nut" href="#"><span>Xe</span></a>
			<a class="nut" href="#"><span>Hãng xe</span></a>
			<a class="nut" href="#"><span>Xác nhận đơn</span></a>
		</div>
		<div class="right">
			<div class="dropdown">
