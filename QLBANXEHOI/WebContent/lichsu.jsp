...
<body>
	<div class="header">
		...
		<div class="left2">
			...
			<a onclick="openPopup()" class="nut" href="#"><span style="color: #5b93f7">Lịch sử</span></a>
		</div>
		<div class="right">
		...
		<div class="left2">
			...
			<a class="nut" href="lichsu?DangNhap=<%=session.getAttribute("DangNhap")%>"><span style="color: #5b93f7">Lịch sử</span></a>
		</div>
		<div class="right">
			<div class="dropdown">
	...
	<div class="body">
		...
		<p style="font-weight: bold;font-size: 30px;margin-bottom: -5px;">Lịch sử mua hàng</p>
		...
		<div>
			...
			<table class="bang">
				...
				<tr style="background-color: #ffffff;height: 10px;"></tr>
				<%
				int i=1;
				if(request.getAttribute("dslichsu")!=null){
				ArrayList<lichsubean> dslichsu = (ArrayList<lichsubean>) request.getAttribute("dslichsu");
				for(lichsubean ls : dslichsu){
				%>
				<tr style="background-color: #ffffff;">
					<td><%=i %></td>
					<td style="font-weight: bold ;color:  #ff0000"><%=ls.machitiethd %></td>
					<td style="font-weight: bold ;color:  #ff0000"><%=ls.mahoadon %></td>
					<td><%=ls.maxe %></td>
					<td><img style="width: 170px; height: 100px;" src="<%=ls.anh %>"></td>
					<td style="font-weight: bold ;"><%=ls.tenxe %></td>
					<td><%=ls.soluongmua %></td>
					<td><%=ls.gia %></td>
					<td style="font-weight: bold ;color:  #ff0000"><%=ls.thanhtien %></td>
					<td><%=ls.ngaymua %></td>
					<td><%=ls.damua %></td>
				</tr>
			<%i++;}} %>
