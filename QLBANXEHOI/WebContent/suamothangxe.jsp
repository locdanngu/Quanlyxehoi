...
<body>
	...
	%> 
	<div  style="background-color :#ededed;height: 671px;">
		<div style="text-align: center;" class="headbody">
			<h1 style="">Chỉnh sửa thông tin một hãng xe</h1>
		</div>
		<div style="text-align: center;display: flex;margin-top: 100px;" class="body">		
			<div style="margin-left: 105px;" class="leftbody">
				<h1>Thông tin hãng xe hiện tại</h1>
				<p>Mã hãng xe: <%=session.getAttribute("mahangxe") %></p>
				<p>Tên hãng xe: <%=session.getAttribute("tenhangxe") %></p>
				<p>Ảnh hãng xe: <img style="width: 30px;height: 20px;" src="<%=session.getAttribute("anhhangxe") %>"></p>
			</div>
			<form action="chinhsuahangxecontroller" method="post">
				<div style="margin-left: 300px;" class="rightbody">
					<h1>Nhập thông tin cho hãng xe</h1>
					<p>Mã hãng xe: <%=session.getAttribute("mahangxe") %></p>
					<input class="input-box9" type="text" name="mahangxe" required="required" value="<%=session.getAttribute("mahangxe") %>" placeholder="Mã hãng xe">
					<input class="input-box" type="text" name="tenhangxemoi" required="required" value="" placeholder="Nhập Tên Hãng Xe mới">
					<div style="margin-left: 100px;margin-top: 30px;" class="preview">
				...
				<button style="margin-top: 210px;margin-left: 300px;background-color: white;color: #6565ff;font-weight: bold;" class="butluusua">Lưu thông tin</button>
			</form>
			<form action="chonhangdexoacontroller" >
				<button style="left: 30px;position: fixed;top:60px;background-color: white;color: #6565ff;font-weight: bold;" class="butluusua">Quay lại</button>
			</form>
		</div>
