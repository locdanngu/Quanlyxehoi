	...
	<div  style="display: flex;">
		<table style="height: 670px;"  >
			<tr>
				...
				<td>
				<form action="chonxemuonxoacontroller" method="post">
					<button class="nutchonxexoa">Chọn 1 xe để xóa</button>
				</form>
				<form style="margin-right: 457px;margin-left: 420px;" action="addxecontroller" method="post">
	                    <h1 style="width: 500px;margin-left: -85px;margin-top: -130px;">Thêm xe vào cơ sở dữ liệu</h1>
	                    <div>
	                        <input style="margin-top: 10px; margin-bottom: 20px;" class="input-box" type="text" name="addtenxe" value="" required="required" placeholder="Nhập tên xe">
	                    </div>
	                    <div>   
	                        <input style="margin-bottom: 20px;" class="input-box" type="text" name="addsoluong" value="" required="required" placeholder="Nhập số lượng">
	                    </div>
	                    <div>   
	                        <input style="margin-bottom: 20px;" class="input-box" type="text" name="addgia" value="" required="required" placeholder="Nhập giá">
	                    </div>
	                    <div style="margin-bottom: 20px; ">   
	                       <!--  <input style="margin-bottom: 20px;" class="input-box" type="text" name="addsoluong" value="" required="required" placeholder="Nhập tên hãng"> -->
	                   	    <select name="addmaxe" style="height: 40px;width: 300px;border-radius: 10px;text-align: center; ">
	                   	    	<%
	                   	    	if(request.getAttribute("dshang")!=null){
	        						ArrayList<hangbean> dshang = (ArrayList<hangbean>) request.getAttribute("dshang");
	        						for(hangbean h : dshang){
	                    ...
	                    <div style="top: 175px;left: 1000px;" class="preview">
	                    ...
	                    <div class="nut99" style="display: inline;">
	                        <button style="height: 35px;margin-top: 10px;color:white ;background-color:  #343a40;" id="but0" type="submit" value="ADDXE">Thêm xe</button>
	                    </div>
