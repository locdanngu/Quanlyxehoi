...
<head>
	<meta charset="utf-8">
	<title>Thông tin xe muốn xóa</title>
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav mr-auto">
		      ...
		      <li style="margin-top:16px">
		      	<form class="form-inline my-2 my-lg-0" action="chonxemuonxoacontroller" method="get">
			      <input style="margin-left:20px; width:300px " name="gttk" class="form-control mr-sm-2" type="text" placeholder="Nhập xe muốn tìm để xóa" aria-label="Search">
		...
		<table style="height: 671px;" >
			<tr>
				<td class="listhead" ><i style="font-weight: bold;" class="fa fa-list" > CÁC LOẠI HÃNG XE</i>
					...
					%>
						<a style="padding-top: 7px;" href="chonxemuonxoacontroller?mh=<%=h.getMahangxe()%>" class="list-items"><img class="anhhangxe" src="<%=h.getAnhhangxe()%>"> <%=h.getTenhangxe() %> </a>
					<%
						}}
					%>
				</td>
				<td style="width: 1295px;">
					<div style="margin-left: 460px;margin-top: -130px;">
						<form action="dongyxoaxecontroller" method="post">
							<h1 style="margin-left: -75px;">Thông tin xe muốn xóa</h1>
							<img style="width: 250px; height: 150px" src="<%=session.getAttribute("anh")%>">
							<p>Mã xe: <%=session.getAttribute("xoamaxe") %></p>
							...
							<p>Giá: <%=session.getAttribute("gia") %></p>
							<p>Ngày nhập: <%=session.getAttribute("ngaynhap") %></p>
							<button class="but100">Đồng ý xóa</button>
							<div>   
			                    <input class="input-box9" type="text"  name="mx" value="<%=session.getAttribute("xoamaxe")%>" placeholder="Mã xe">
			                </div>
						</form>
						<form action="chonxemuonxoacontroller">
							<button style="margin-top: 0px;" class="but100">Quay lại</button>
						</form>
