...
<body>
	<div class="header">
		...
		<div class="left2">
			...
			<a style="border-bottom: 3px solid #ffffff;" onclick="openPopup()" class="nut" href="#"><span class="cn">Xác nhận đơn</span></a>
		</div>
		...
		<div class="left2">
			...
			<a style="border-bottom: 3px solid #ffffff;" class="nut" href="qldon"><span class="cn">Xác nhận đơn</span><span class="badge bg-danger"><%=session.getAttribute("xn") %></span></a>
		</div>
		<div class="right">
			<div class="dropdown">
	...
	<div class="body">
			...
			<div>
				<p class="tieude">Đơn hàng đợi xác nhận giao</p>	
			</div>
			<div style="margin-left: 7%; margin-right: 7%; width: 84%">
				<table style="background-color: #343a40;width: 1290px;text-align: center;">
					...
					<%
						...
						ArrayList<xacnhanbean> dsxn = (ArrayList<xacnhanbean>) request.getAttribute("dsxn");
						for(xacnhanbean xn: dsxn){
						%>
					<tr style="height: 15px;border: 0px;background-color: #454d55;"></tr>
					<tr>
						<td><%=xn.mahoadon %></td>
						<td><%=xn.machitiethd %></td>
						<td><%=xn.makh %></td>
						<td><%=xn.maxe %></td>
						<td><%=xn.tenxe %></td>
						<td><img style="width: 170px; height: 100px;" src="<%=xn.anh %>"></td>
						<td><%=xn.tenhangxe %></td>
						<td><%=xn.tendn %></td>
						<td><%=xn.soluongmua %></td>
						<td><%=xn.gia %></td>
						<td><%=xn.thanhtien %></td>
						<td><%=xn.ngaymua %></td>
						<td><%=xn.soluongtonkho %></td>
						<td style="">
							<a style="" href="chapnhangiao?machitiethd=<%=xn.machitiethd%>&maxe=<%=xn.maxe%>&soluongmua=<%=xn.soluongmua%>">Chấp nhận giao</a> | 
							<a style="" href="tuchoigiao?machitiethd=<%=xn.machitiethd%>&tendn=<%=xn.tendn%>&sotien=<%=xn.thanhtien%>">Từ chối</a>
						</td>
