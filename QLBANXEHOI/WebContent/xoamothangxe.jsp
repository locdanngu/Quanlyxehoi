...
<body>
	...
	<div  style="background-color :#ededed;height: 671px;">
		<div style="text-align: center;" class="headbody">
			<h1 style="">Xóa một hãng xe</h1>
		</div>
		<div style="text-align:center;" class="body">		
			<form style="margin-top: 140px; " action="dongyxoahangcontroller" method="post">
				...
				<input class="input-box9" type="text" name="mhx" value="<%=session.getAttribute("mahangxe")%>">
				<button style="margin-top: 40px;margin-left: 100px;" class="lamdep">Đồng ý xóa</button>
			</form>
			<form style="margin-top: -30px;margin-left: -130px;" action="chonhangdexoacontroller">
				<button class="lamdep">Quay lại</button>
			</form>
		</div>
