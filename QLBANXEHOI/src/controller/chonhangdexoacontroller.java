...
/**
 * Servlet implementation class chonhangdexoacontroller
 */
@WebServlet("/chonhangdexoacontroller")
public class chonhangdexoacontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public chonhangdexoacontroller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("thongtinhangxe.jsp");
