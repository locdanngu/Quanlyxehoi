...
/**
 * Servlet implementation class chonxemuonxoacontroller
 */
@WebServlet("/chonxemuonxoacontroller")
public class chonxemuonxoacontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public chonxemuonxoacontroller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("chonxemuonxoa.jsp");
