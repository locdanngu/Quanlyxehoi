...
/**
 * Servlet implementation class dongythanhtoancontroller
 */
@WebServlet("/dongythanhtoancontroller")
public class dongythanhtoancontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public dongythanhtoancontroller() {
        super();
