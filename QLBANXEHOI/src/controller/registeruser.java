...
public class registeruser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String address = request.getParameter("addressdk");
		String phone = request.getParameter("phonedk");
		String email = request.getParameter("emaildk");
		String username = request.getParameter("usernamedk");
		String password = request.getParameter("passworddk");
