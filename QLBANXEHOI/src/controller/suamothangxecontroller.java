...
/**
 * Servlet implementation class suamothangxecontroller
 */
@WebServlet("/suamothangxecontroller")
public class suamothangxecontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public suamothangxecontroller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("suamothangxe.jsp");
