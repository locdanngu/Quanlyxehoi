...
/**
 * Servlet implementation class suaxe
 */
@WebServlet("/suaxe")
public class suaxe extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Date addngaynhap = Date.valueOf(request.getParameter("addnn"));
		...
		xebo x = new xebo();
		x.editxe(addtenxe, addsl, addgia, addmahangxe, addanh, addngaynhap, mx);
