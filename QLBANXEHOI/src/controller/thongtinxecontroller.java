...
/**
 * Servlet implementation class thongtinxecontroller
 */
@WebServlet("/thongtinxecontroller")
public class thongtinxecontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public thongtinxecontroller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("thongtinxe.jsp");
